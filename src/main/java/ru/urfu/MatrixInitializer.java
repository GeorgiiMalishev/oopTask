...
public class MatrixInitializer {
     ...
     *         (поставить breakpoint на возникающее исключение и воспользоваться стеком вызовов)
     *         -4390925508
     *     </li>
     ...
     *         Я исправил получение из матрицы левого элемента в getValue, так как фактически мы получали левый нижний элемент.
     *     <li>Найти значение value перед добавлением значения элемента массива с индексами [95][30]
     *         (нужно использовать условия)
     *         43</li>
